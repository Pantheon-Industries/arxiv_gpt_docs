...
1. **Obtain API Credentials**: 
   - Subscribe to our API and get your key from [RapidAPI](https://rapidapi.com/maxhager28/api/arxivgpt).
...
Visit our [RapidAPI page](https://rapidapi.com/maxhager28/api/arxivgpt) for up-to-date information on:
